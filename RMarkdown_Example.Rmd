...
library(ggplot2)
ggplot(shelter, aes(x=Days.to.Adoption)) +  geom_histogram(binwidth=10, col='black', fill='blue') + xlab('Number of Days to Adoption') + ggtitle('Distribution of Days to Adoption') + theme_classic()
```
