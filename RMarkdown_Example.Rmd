...
```{r results='hide'}
median(shelter$Days.to.Adoption)
```
...
library(ggplot2)
ggplot(shelter, aes(x=Days.to.Adoption)) +  geom_histogram(binwidth=10, col='black', fill='green') + xlab('Number of Days to Adoption') + ggtitle('Distribution of Days to Adoption') + theme_classic()
```
